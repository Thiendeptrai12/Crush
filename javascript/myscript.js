...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Ê ê tim đang rung động rồi đó :33 " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Thiện có điều muốn nói nè :33:';
...
author.innerHTML = "Mọi thắc mắc bạn có thể liên hệ<a href='https://www.facebook.com/thiennguyenchizs/'>ThiệnNguyễn Chí<a>";
